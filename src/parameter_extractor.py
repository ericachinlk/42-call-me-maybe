...
from src.models import FunctionDefinition, ParameterType, TestPrompt
...
class ParameterExtractor(BaseModel):
    ...
    def extract(self, fn_def: FunctionDefinition, user_prompt: TestPrompt) -> dict[str, Any]:
    ...
    def _build_prompt(self, fn_def: FunctionDefinition, user_prompt: TestPrompt) -> str:
        lines = [
